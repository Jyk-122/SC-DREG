...
class UNet(nn.Module):
    def __init__(self, in_dim, out_dim, num_filters):
        ...
        # Bridge
        self.bridge = conv_block_2_2d(self.num_filters * 16, self.num_filters * 32, activation)
        
        # Up sampling
        self.trans_1 = conv_trans_block_2d(self.num_filters * 32, self.num_filters * 32, activation)
        self.up_1 = conv_block_2_2d(self.num_filters * 48, self.num_filters * 16, activation)
        self.trans_2 = conv_trans_block_2d(self.num_filters * 16, self.num_filters * 16, activation)
        self.up_2 = conv_block_2_2d(self.num_filters * 24, self.num_filters * 8, activation)
        self.trans_3 = conv_trans_block_2d(self.num_filters * 8, self.num_filters * 8, activation)
        self.up_3 = conv_block_2_2d(self.num_filters * 12, self.num_filters * 4, activation)
        self.trans_4 = conv_trans_block_2d(self.num_filters * 4, self.num_filters * 4, activation)
        self.up_4 = conv_block_2_2d(self.num_filters * 6, self.num_filters * 2, activation)
        self.trans_5 = conv_trans_block_2d(self.num_filters * 2, self.num_filters * 2, activation)
        self.up_5 = conv_block_2_2d(self.num_filters * 3, self.num_filters * 1, activation)
